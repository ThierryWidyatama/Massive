...
const Pesanan = () => {
    ...
    const calculatePayment = () => {
        ...
        const subtotal = servicePrice + totalPeoplePrice;
        return {
            additionalPeople,
            subtotal,
            serviceFee,
    ...
    const changeMonth = (direction) => {
        ...
        if (selectedMonth < currentMonth || selectedMonth > currentMonth + 2) {
            selectedMonth -= direction;
            return;
        }
        if (selectedMonth > 11) {
    ...
    const submitOrder = () => {
        const orderData = {
            ...
            alamat: alamat,
            tanggal: selectedDate.toISOString().split('T')[0], // format yyyy-mm-dd
            waktu: selectedTime,
                ...
                {step === 4 && (
                    <div id="step4">
                        ...
                        <div className="time-selector-pesanan">
                            ...
                            <button className="continue-button-pesanan4" disabled={!isStep4Valid} onClick={() => setStep(5)}>Lanjut</button>
                        </div>
                    </div>
                )}
                {step === 5 && (
